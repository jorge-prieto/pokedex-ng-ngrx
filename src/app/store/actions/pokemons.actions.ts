...
export const usePokemons = createAction('[Home] Use Pokemons');

export const loadPokemons = createAction('[App] Load Pokemons');
...
export const addPokemons = createAction('[Pokemons] Add Pokemons');
